            ...
            <div className='parent-memo'>
                <div className='header-momo'>
                    <div className='memo-dialogue-box1'>
                        <div className='memo-image'><img src={item.thumb}/></div><div className='memo-info'>
                            <h2>{item.product_name}</h2>
                           <h2>{item.brandname}</h2>
                            <h2>{item.logic}</h2>
                            <h2>Memories</h2><div className='grid-memo'>
                                <img src={item.momories1}/>
                                <img src={item.momories2}/>
                                <img src={item.momories3}/>
                                <img src={item.momories4}/>
                            </div>
                            </div>
                    </div>
                </div>
...
return(<div>
    ...
    <div className='Memories_card'>{modalOpen && <Modal setOpenModal={setModalOpen} />}
    ...
    <div className='parent-memo'>
                <div className='header-momo'>
                        ...
                        <div className='memo-image'><img src={pic}/></div><div className='memo-info'>
                            <h2>Jacket</h2>
                            <h2>Zara</h2>
                            <h2>6 US</h2>
                            <h3>@description</h3>
                            <h2 id='heading'>Memories</h2><div className='grid-memo'>
                            <img src={pic}/>
                            <img src={pic}/>
                            <img src={pic}/>
                            <img src={pic}/>
                ...
                <div className='footer-memo'>
                        ...
                        <div className='btn-memo'><button id='auction' className="openModalBtn"  onClick={() => {
          setModalOpen(true);
        }}>Auction</button><button id='Add'  onClick={() => {
            setAddmemoryOpen(true);
          }}>Add Memory</button></div>
        <div className='item-information'>
                        <div className='item-history'>
                            <h2>Item History</h2>
                            <h3>Brought by @bidder<br/>
                            1 day ago</h3><hr/>
                            <h3>Minted by @sidco in channel series<br/> 3 days ago
                            </h3>
                        </div><h2>Royalty Distribution</h2>

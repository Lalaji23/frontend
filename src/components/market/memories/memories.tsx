    ...
    <div className='parent-memo'>
                ...
                <div className='footer-memo'>
                    <div className='footer-left'>
                        <div className='btn-memo'><button id='bid' className="openModalBtn"  onClick={() => {
            setBidOpen(true);
          }}>BID</button></div><div className='auction-details'><h3>Auction details</h3>
          <h5>@bidder bid  1E 20 days ago</h5>
          <h5>@bidder bid  1E 20 days ago</h5></div></div>
        <div className='item-information'>
                        <div className='item-history'>
                            <h2>Item History</h2>
                            
                            <h3>Minted by @sidco in <br/>schannel series<br/> 3 days ago
                            </h3>
                        </div>

...
export default function User() {const [NewOpen, setNewOpen] = useState(false);
  return (
    <div><div className="user-container">{NewOpen && <New setOpenNew={setNewOpen} />}
        ...
        <Link to={'/mint'}> <button>Mint</button></Link></div></div>
        ...
        <div className='footer1-right'><h2>item title</h2><h3>metadata</h3><Link to={'/manage-auction-page'}> <sup>manage</sup></Link></div></div> <div className='footer-left1'><div className='footer1left'><img className='small-img' src={pic}></img></div><div className='footer1-right'><h2>item title</h2><h3>metadata</h3><Link to={'/manage-auction-page'}> <sup>manage</sup></Link></div></div></div><div className="user-footer-right"><h1>Notification</h1>
